...
const Index = () => {
  ...
  const submitContact = handleSubmit((data) => {
  ...
  return (
    <div className="mt-6">
      <div className="grid md:grid-cols-2 grid-cols-1 items-start gap-14 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
        <div>
        ...
        <FormProvider {...methods}>
          <form className="ml-auo space-y-4" onSubmit={submitContact}>
            <input
              type="text"
              name="name"
              placeholder="Name"
